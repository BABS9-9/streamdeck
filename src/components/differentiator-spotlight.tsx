...
const spotlightPriority: Record<ScreenId, string[]> = {
  login: ['fast-provider-switch-authority', 'line-release-witness', 'multi-connection-switching', 'continuity-window', 'multi-connection-custody', 'provider-drop-continuity', 'first-picture-fast-path', 'remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  home: ['fast-provider-switch-authority', 'line-release-witness', 'multi-connection-switching', 'continuity-window', 'multi-connection-custody', 'provider-drop-continuity', 'first-picture-fast-path', 'remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  live: ['fast-provider-switch-authority', 'line-release-witness', 'multi-connection-switching', 'continuity-window', 'multi-connection-custody', 'provider-drop-continuity', 'first-picture-fast-path', 'remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
};
