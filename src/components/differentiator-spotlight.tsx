...
const spotlightPriority: Record<ScreenId, string[]> = {
  login: ['remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  home: ['remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  live: ['remote-first-control', 'focus-return-memory', 'selection-custody', 'saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'recovery-witness', 'provider-choice-truth', 'provider-switch-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'explanation-boundary', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
};
