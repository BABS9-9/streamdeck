...
const spotlightPriority: Record<ScreenId, string[]> = {
  login: ['saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'provider-choice-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  home: ['saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'provider-choice-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
  live: ['saved-provider-podium', 'provider-stability-truth', 'return-cooldown-truth', 'provider-choice-truth', 'launch-readiness', 'launch-scorecard', 'proof-debt', 'proof-provenance', 'hold-receipt', 'claim-ceiling', 'connection-headroom', 'rescue-receipt', 'reset-boundary', 'identity-anchor', 'canonical-provider-identity', 'fallback-ranking', 'fallback-equivalence', 'fallback-expiry-truth', 'guide-freshness-board'],
};
