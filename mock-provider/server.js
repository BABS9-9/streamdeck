...
const phaseOneCheckpointRefreshedAt = '2026-09-01T07:00:00-04:00';
const phaseOneCheckpointRunLabel = 'Axe cron refresh · 2026-09-01 07:00 ET';
...
const buildDifferentiators = () => ([
  ...
  },
  {
    ...
    detail: 'The adapter now publishes beside Connect what visible proof must survive on Login, what setup context that proof carries forward, and what missing evidence means fallback is no longer trustworthy.',
    surface: 'login',
  },
  {
  ...
  },
  {
    ...
    detail: 'The adapter now publishes beside the hero CTA what visible browse proof must survive on Home, what discovery context that proof carries forward, and what missing evidence means the hero has turned into confidence theater.',
    surface: 'home',
  },
  {
  ...
  },
  {
    ...
    detail: 'The adapter now publishes beside Play what visible surf proof must survive on the selected card, what launch context that proof carries forward, and what missing evidence means rescue has become a disguised restart.',
    surface: 'live',
  },
  {
  ...
  {
    title: 'Provider-switch truth on Login',
    detail: 'The adapter now publishes beside Connect when another saved provider should inherit the next Home move, what setup context survives that handoff, and what proof still lets the current provider stay in charge.',
    surface: 'login',
  },
  {
    title: 'Provider-switch truth on Home',
    detail: 'The adapter now publishes beside the hero CTA when the featured launch should move to another saved provider, what hero and rail context survives that handoff, and what proof still lets the current provider keep browse ownership.',
    surface: 'home',
  },
  {
    title: 'Provider-switch truth on Live',
    detail: 'The adapter now publishes beside Play when the selected card should move to another saved provider, what category and preview context survives that handoff, and what proof still lets the current provider keep watch ownership.',
    surface: 'live',
  },
  {
    title: 'Identity anchor on Login',
...
const buildCompetitiveDifferentiators = () => ([
  {
    ...
    buildPhase: 'Phase 1',
    architectureNotes: 'Persist canonical provider IDs, auth summaries, provider-specific caches, explicit launch ownership, and one-tap quick-switch actions so switching does not corrupt favorites, history, search, or playback context.',
    surfaces: ['login', 'home', 'live'],
  },
  {
    slug: 'fast-provider-switch-authority',
    feature: 'Fast provider-switch authority',
    pitch: 'Keep the healthiest saved provider, reconnect trust, recent handoff witness, and exact fail-closed blocker visible before a quick switch ever fires.',
    competitiveGap: 'Competitors usually present saved-provider switching like a harmless shortcut, so users only discover stale proof, expired accounts, or saturated line caps after the handoff already failed.',
    buildPhase: 'Phase 1',
    architectureNotes: 'Drive Login, Home, and Live from one quick-switch runtime that ranks active authority, standby authority, reconnect trust, recent handoff context, line headroom, and exact fail-closed reasons, then let the premium CTA switch straight to the healthiest saved provider only when that runtime still says the move is honest.',
    surfaces: ['login', 'home', 'live'],
  },
  {
  ...
  {
    slug: 'proof-provenance',
    feature: 'Proof provenance',
    pitch: 'Publish whether the next premium CTA is currently backed by fresh provider proof, saved continuity, or rescue logic before reassurance sounds more live than its source.',
    competitiveGap: 'Competitors usually let cached continuity or fallback logic speak with the same authority as fresh provider proof, so users cannot tell what actually earned current confidence.',
    buildPhase: 'Phase 1',
    architectureNotes: 'Drive Login, Home, and Live from one proof-provenance contract and keep that source-of-truth story visible beside Connect, the hero CTA, and Play so premium reassurance never hides what layer is really backing the next move.',
    surfaces: ['login', 'home', 'live'],
  },
  {
  ...
  {
    slug: 'provider-switch-truth',
    feature: 'Provider switch truth',
    pitch: 'Tell users exactly when the current provider should lose the next move, what setup, browse, or selected-channel context survives the handoff, and what proof still lets the current provider stay in charge.',
    competitiveGap: 'Competitors usually bury provider switching in settings or only explain it after failure, so ownership changes feel abrupt, suspicious, or already too late to trust.',
    buildPhase: 'Phase 1',
    architectureNotes: 'Drive Login, Home, and Live from one provider-switch contract so switch triggers, preserved context, and stay-proof stay aligned beside Connect, the hero CTA, and Play before a saved-provider handoff quietly changes ownership.',
    surfaces: ['login', 'home', 'live'],
  },
  {
  ...
  },
  {
    ...
    pitch: 'Tell users beside Connect, the hero CTA, and Play what exact evidence proves rescue preserved the same destination, what context still carries forward, and what contradiction breaks that trust immediately.',
    ...
    buildPhase: 'Phase 1',
    architectureNotes: 'Drive Login, Home, and Live from one recovery-witness contract so required evidence, preserved context, and trust-break triggers stay aligned beside Connect, the hero CTA, and Play before rescue copy can overclaim sameness.',
    surfaces: ['login', 'home', 'live'],
  },
  {
    slug: 'rescue-receipt',
...
const buildAdapterManifest = (scenario = 'healthy') => ({
  ...
  supportedScreens: [
    {
      ...
      proof: [
        ...
        'Proof provenance stays visible beside Connect before Login implies fresh auth is still backing the next move',
        ...
        'Keep the current claim ceiling visible beside Connect before premium setup copy survives degraded proof',
      ],
    ...
    },
    {
      ...
      proof: [
        ...
        'Hero proof provenance stays visible beside the hero CTA before cache or rescue sounds like live provider browse proof',
        ...
        'Hero claim ceiling stays visible beside the hero CTA before cinematic browse language outruns proof',
      ],
    ...
    },
    {
      ...
      proof: [
        ...
        'Selected-card proof provenance stays visible beside Play before same-category rescue sounds like exact-channel proof',
        ...
        'Selected-card claim ceiling stays visible beside Play before preview polish sounds safer than current proof',
      ],
  ...
  browseLaunchScorecards: buildBrowseLaunchScorecards(scenario),
        ...
        assignments: [
      {
        ...
        proof: 'Competitive matrix, ship lanes, and assignment-grade surface implications are documented for Login, Home, and Live and re-stamped for the 7:00 AM ET cron checkpoint.',
      },
      {
        id: 'adapter',
