...
- Ship next: stronger cross-provider search ranking and persistence, deeper continue-watching resume accuracy, folder management, connection rename/remove/retry actions
