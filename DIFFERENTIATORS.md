...
12. Canonical ownership continuity
...
1. Keep Phase 1 strongest on multi-connection switching, smart EPG overlay, guide freshness board, continue watching, instant preview, collections, provider risk strip, proof debt, claim ceiling, connection headroom, provider choice truth, autonomy boundary, launch readiness, launch scorecard, canonical provider identity, fallback ranking, fallback equivalence, and stream-health HUD.
