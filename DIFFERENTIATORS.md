...
- Ship now: saved-provider login, inline NOW/NEXT guide context, live browser preview, provider-aware history/favorites, stream health HUD, and a global player dock with real resume tracking for movies and series
- Ship next: stronger cross-provider search ranking and persistence, deeper continue-watching resume accuracy, richer folder smart-rules, connection rename/remove/retry actions
